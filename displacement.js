...
var Application = (function () {
    function Application() {
        ...
        this.transitions.push(new Transition({
            ...
            stage: this.stage,
            image: "https://raw.githubusercontent.com/ameliasom/Olympus/master/jupiter-pia21390.jpeg",
        ...
        this.transitions.push(new Transition({
            renderer: this.renderer,
            stage: this.stage,
            image: "https://raw.githubusercontent.com/ameliasom/Olympus/master/jupiter-pia21394.jpg",
            index: this.transitions.length,
            zoom: 4
        }));
        this.transitions.push(new Transition({
            renderer: this.renderer,
            stage: this.stage,
            image: "https://raw.githubusercontent.com/ameliasom/Olympus/master/jupiter-pia21972.jpg",
            index: this.transitions.length,
            zoom: 4
        }));
        this.transitions.push(new Transition({
            renderer: this.renderer,
            stage: this.stage,
            image: "https://raw.githubusercontent.com/ameliasom/Olympus/master/jupiter-pia21973.jpg",
            index: this.transitions.length,
            zoom: 6
        }));
        this.render();
...
var Transition = (function () {
    function Transition(options) {
        ...
        // mask image
        texture = PIXI.Texture.fromImage("https://raw.githubusercontent.com/ameliasom/Olympus/master/jupiter-pia21972.jpg");
